    ...
    return (
      <View style={styles.container}>
        <View style={styles.primary}>
          ...
          <Button
            icon={{type: 'font-awesome', name: 'send', style: { marginRight: 0 }}}
            color={Colors.buttons.common.text}
            disabled={this.state.text === ''}
            disabledStyle={{backgroundColor: Colors.buttons.common.disabled}}
            backgroundColor={Colors.buttons.common.background}
            buttonStyle={{borderRadius: 25, width: 50, height: 50}}
