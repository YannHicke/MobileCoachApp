      ...
      <View style={styles.container}>
        ...
        <View style={styles.textContainer}>
          <Text style={styles.subtitle}>
            {I18n.t('Onboarding.checkQrUsageSubtitle')}
          </Text>
          <NextButton
            text={I18n.t('Onboarding.qrAvailable')}
            onPress={onQRAvailable}
          />
          <NextButton
            text={I18n.t('Onboarding.qrNotAvailable')}
            onPress={onNoQRAvailable}
          />
        </View>
      </View>
    );
