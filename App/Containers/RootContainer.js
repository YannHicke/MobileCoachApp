...
class RootContainer extends Component {
  ...
  UNSAFE_componentWillReceiveProps (newProps) { // TODO fabian. Move to componentDidUpdate
    console.log('fabian: RootContainer.js:componentWillReceivProps', this.props, newProps)
