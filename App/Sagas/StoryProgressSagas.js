...
export function * watchAddDashboardMessages (action) {
  ...
  if (currentScreen !== 'DashboardChat') {
    log.info('Received DashboardMessage while not in DashboardChat: Incrementing unread Dashboard Messages badge.')
    yield put({type: StoryProgressActions.INCREMENT_UNREAD_DASHBOARD_MESSAGES})
  }
}
